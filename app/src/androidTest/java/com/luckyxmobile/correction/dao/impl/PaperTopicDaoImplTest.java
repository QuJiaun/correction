...
public class PaperTopicDaoImplTest extends LitePalTestCase {
    ...
    private Book book;
    private com.luckyxmobile.correction.model.bean.PaperTopic paper_topic1;
    private com.luckyxmobile.correction.model.bean.PaperTopic paper_topic2;
    ...
    public void deleteFakeData() {
        ...
        LitePal.delete(com.luckyxmobile.correction.model.bean.PaperTopic.class, paper_topic1.getId());
        LitePal.delete(com.luckyxmobile.correction.model.bean.PaperTopic.class, paper_topic2.getId());
    }
    @Test
    public void save() {
