...
public class TopicRightAdapter extends RecyclerView.Adapter<TopicRightAdapter.ViewHolder> {
    ...
    public TopicRightAdapter(Context context, Topic topic, LinearLayout linearLayout){
        ...
        String text = topic.getTopic_right_solution_text();
        ...
        public ViewHolder(View itemView) {
            ...
            deleteImage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    topic.setTopic_right_solution_picture(FastJsonUtil.objectToJson(topicImagesHighlighter));
                    topic.save();
                    imagesPath = getImagesPath();
