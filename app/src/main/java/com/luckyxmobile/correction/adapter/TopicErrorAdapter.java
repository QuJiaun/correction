...
public class TopicErrorAdapter extends RecyclerView.Adapter<TopicErrorAdapter.ViewHolder> {
    ...
    public TopicErrorAdapter(Context context, Topic topic, LinearLayout linearLayout){
        ...
        String text = topic.getTopic_error_solution_text();
        ...
        public ViewHolder(View itemView) {
            ...
            deleteImage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    topic.setTopic_error_solution_picture(FastJsonUtil.objectToJson(topicImagesHighlighter));
                    topic.save();
                    imagesPath = getImagesPath();
