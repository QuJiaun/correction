...
public class TopicErrorCauseAdapter extends RecyclerView.Adapter<TopicErrorCauseAdapter.ViewHolder> {
    ...
    public TopicErrorCauseAdapter(Context context, Topic topic, LinearLayout linearLayout){
        ...
        String text = topic.getTopic_error_cause_text();
        ...
        public ViewHolder(View itemView) {
            ...
            deleteImage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    topic.setTopic_error_cause_picture(FastJsonUtil.objectToJson(topicImagesHighlighter));
                    topic.save();
                    imagesPath = getImagesPath();
